      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <div className="bg-white rounded-xl p-8 shadow-xl text-center">
            ...
            <Button asChild className="mt-8 bg-primary-500 hover:bg-primary-600 text-white font-medium py-3 px-8 rounded-full transition-all transform hover:scale-105">
